 ...
 * Invokes the GooglePubSubService.
 *
 */
@MessageEndpoint
@ConditionalOnProperty(prefix = "service.google-pubsub", value = "enabled", havingValue = "true")
public class GooglePubSubServiceActivator implements IServiceActivator {

    private static final Logger logger = LoggerFactory.getLogger(GooglePubSubServiceActivator.class);
    @Autowired
    GooglePubSubService service;
